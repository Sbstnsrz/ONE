...
function contruirTr(paciente){
    ...
    var pesoTd = contruirTd(paciente.peso, "info-peso");
    var alturaTd = contruirTd(paciente.altura, "info-altura");
    var gorduraTd = contruirTd(paciente.gordura, "info-gordura");
    var imcTd = contruirTd(paciente.imc, "info-imc");
